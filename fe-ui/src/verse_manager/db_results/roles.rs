...
pub(super) fn handle_peer_roles_resolved(scope: &str, roles: &[(String, String)], ui_mgr: &mut UiManager) {
...
pub(super) fn handle_role_assigned(peer_did: &str, scope: &str, role: &str, ui_mgr: &mut UiManager) {
...
pub(super) fn handle_local_role_resolved(scope: &str, role: &str, local_role: &mut crate::plugin::LocalUserRole) {
