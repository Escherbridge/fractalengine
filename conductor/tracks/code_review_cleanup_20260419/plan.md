...
- [x] Task 1.1: Write navigation handler security tests (TDD Red)
...
- [x] Task 1.2: Implement navigation handler validation (TDD Green)
...
- [x] Task 1.3: Refactor and verify (TDD Refactor)
...
- [x] Verification: Phase 1 Manual Verification [checkpoint marker]
...
- [x] Task 2.1: Delete dead guard/flush code from petal_portal.rs (TDD: verify no references, then delete)
...
- [x] Task 2.5: Add VerseManager systems to UiSet ordering
...
- [x] Task 3.1: Fix node_options_save_url DB persistence (TDD: Write test, implement, refactor)
...
- [x] Task 3.2: Cache portal URL hostname (TDD: Write test, implement, refactor)
...
- [x] Task 3.3: Fix context menu close detection (TDD: Write test, implement, refactor)
