...
- [ ] Task: Write frame budget test:
  - Run the Bevy app with synthetic channel traffic (10 messages/frame on both channels) for 300 frames
  - Record `FrameTime` diagnostics each frame
  - Assert no frame exceeds 20ms (16.67ms budget + 20% headroom)
